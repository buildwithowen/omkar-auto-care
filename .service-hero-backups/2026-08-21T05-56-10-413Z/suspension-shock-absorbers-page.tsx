...
export const metadata: Metadata = {
  ...
  description: "Professional suspension and shock absorber inspections and repairs by Omkar Autocare. Improve ride comfort and vehicle handling.",
    ...
    <section className={styles.hero}>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.content}>
          ...
          <p>
            Improve comfort, handling and stability with professional suspension and shock absorber servicing from{" "}
