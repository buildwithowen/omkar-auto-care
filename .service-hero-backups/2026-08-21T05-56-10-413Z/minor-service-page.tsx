...
export const metadata: Metadata = {
  ...
  description: "Professional minor vehicle servicing by Omkar Autocare. Keep your car running smoothly with convenient mobile maintenance.",
    ...
    <section className={styles.hero}>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.content}>
          <h1>
            Stay ready for the road.
            <br />
            <span style={{ color: "#fd8833", whiteSpace: "normal" }}>
              Minor Service.
            </span>
          </h1>

          <p>
            Keep your vehicle performing at its best with reliable routine servicing and maintenance from{" "}
