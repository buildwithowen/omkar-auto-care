...
export const metadata: Metadata = {
  ...
  description: "Professional serpentine and timing belt inspections and replacements by Omkar Autocare. Protect your engine with expert mobile servicing.",
    ...
    <section className={styles.hero}>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.content}>
          ...
          <p>
            Protect your engine with professional serpentine and timing belt inspections, replacements and repairs from{" "}
