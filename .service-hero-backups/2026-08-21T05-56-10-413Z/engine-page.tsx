...
export const metadata: Metadata = {
  ...
  description: "Professional engine diagnostics, maintenance and repairs by Omkar Autocare. Reliable mobile mechanic services for your vehicle.",
    ...
    <section className={styles.hero}>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.content}>
          ...
          <p>
            Maintain reliable performance with expert engine diagnostics, servicing and repairs from{" "}
