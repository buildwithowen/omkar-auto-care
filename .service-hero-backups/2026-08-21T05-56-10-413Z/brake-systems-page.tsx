...
export const metadata: Metadata = {
  ...
  description: "Professional brake inspections, repairs and maintenance by Omkar Autocare. Keep your vehicle safe with dependable mobile brake servicing.",
    ...
    <section className={styles.hero}>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.content}>
          ...
          <p>
            Protect every journey with professional brake inspections, repairs and maintenance from{" "}
